...
I am applying for the Junior Intelligence Analyst position in Berlin. What drew me to Venatic is the combination of investigative tradecraft and technology: finding and verifying information across fragmented public sources, understanding ownership networks and risk, and turning that work into clear analysis for clients.

My formal background is in AI engineering rather than a traditional intelligence track, but the part of that work I have found most compelling is closely related to investigation: resolving messy entities, evaluating evidence, tracing why a conclusion is supported, preserving contradictions and uncertainty, and deciding what information is worth collecting next. I wanted to demonstrate that ability rather than only describe it, so I built a targeted proof of work for this application.

The result is **SafeTrace Intelligence Desk**, centred on a synthetic 28-source investigation across Germany, the UK, UAE, Cyprus and Serbia. The case requires the analyst to untangle multi-layer ownership and voting rights, test an apparent sanctions connection, distinguish legal asset ownership from operation and lender security, handle contradictory company records, evaluate an unusual payment route and prioritise follow-up research under a strict evidence budget.
...
I would be very glad to discuss the proof and, more importantly, learn how your team approaches these investigations in practice.
